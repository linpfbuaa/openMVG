...
int main(int argc, char** argv)
{
	...
	cmd.add(make_option('y', pcnum, "pc_num"));
	...
	else // Compute the putative matches
	{
		...
		system::Timer timer;
		{
			...
			for (size_t machine_i = machine_num * n_1; machine_i < machine_num * n_1 + n_ect; machine_i++) {
			...
			collectionMatcher->Match(regions_provider, pair_part, map_PutativesMatches, &progress);          
			//---------------------------------------
